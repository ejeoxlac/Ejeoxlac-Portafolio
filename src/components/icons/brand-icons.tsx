...
type BeaconsIconProps = BrandIconProps

export function BeaconsIcon({
  size = 22,
  className,
  ...props
}: BeaconsIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <circle cx="9.4" cy="7.6" r="4.2" />
      <circle cx="16.9" cy="7" r="2.15" />
      <circle cx="16.4" cy="14.6" r="4.4" />
      <circle cx="5.1" cy="13.2" r="2.15" />
      <circle cx="9" cy="17.8" r="2.65" />
    </svg>
  )
}
